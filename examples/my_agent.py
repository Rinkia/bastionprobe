...
Rules:
  ...
  - Return the agent's real reply text and the real names of any tools it called
    this turn. Don't sanitize - agentprobe is measuring what your agent does.
"""
